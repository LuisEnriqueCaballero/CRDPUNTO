...
$con =$conectar->conexion();
    ...
    $especialidad=mysqli_real_escape_string($con,htmlentities($_POST['especialidad']));
    ...
    if(buscarRepetido($usuario,$con) == 1){
      echo 2 ; 
        ...
        $sql ="INSERT INTO odontologo (DocumentoI,Tipo_documento,nombre,apellido,fecha,sexo,telefono,correo_electronico,cop,bienvenida,clinica,departamento,provincia,distrito,direccion,usuario,pasword,Id_roll,especialidad)
        VALUES('$numero','$tipo_documento','$nombre','$apellido','$cumpleaño','$genero','$telefono','$correo','$cop','$bienvenida','$clinica','$departamento','$provincia','$distrito','$direccion','$usuario','$password','$tipo','$especialidad')";
