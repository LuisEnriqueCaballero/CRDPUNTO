                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <nav class="navbar navbar-light bg-light justify-content-between">
                                    ...
                                    <a class="navbar-brand" href="formularioradiografia.php"><button class="btn btn-outline-info"><i class="fa fa-plus" aria-hidden="true"></i><span> Nuevo Servicio</span></button></a>
