                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header">
                            <h2 style="text-align:center; font-weight:700; color:#1aa5be">LISTA DE MIS CLIENTE</h2>
                        </div>
                        <div class="card-body">
                            <nav class="navbar navbar-light bg-light">
                                <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#pacienteregistrar">Registrar nuevo <i class="fa fa-male" aria-hidden="true"></i></button>
                            </nav>
