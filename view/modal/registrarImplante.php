<!-- Modal -->
<div class="modal fade" id="implanteregistrar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <form id="formulario">
          <div class="form-row">
            ...
            <div class="form-group col-md-5">
              ...
              <input type="text" name="modelo" id="modelo" class="form-control" placeholder="Ingrese el nombre del modelo de implante" autocomplete="off" onKeyUp="this.value=this.value.toUpperCase();">
            </div>
